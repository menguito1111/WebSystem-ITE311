        ...
        <div class="col-12">
            <div class="bg-primary text-white p-4 rounded-3 shadow-sm">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h2 class="mb-1">Course Management Dashboard</h2>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="mb-0 fw-bold text-primary"><?= $totalCourses ?? 0 ?></h4>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="mb-0 fw-bold text-success"><?= $activeCourses ?? 0 ?></h4>
                                    ...
                                    <tr class="course-row"
                                        ...
                                        <td class="px-4 py-3 text-center">
                                            <div class="btn-group" role="group">
                                                <a href="<?= base_url('/admin/manage-course/') . $course['course_id'] ?>"
